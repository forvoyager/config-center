        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                if (flashInstalled) {
                    ...
                    $button.html('<span id="uploadify-button-text-id">' + settings.buttonText + '</span>')
                        .css({
                            'height': settings.height + 'px',
                    ...
                    //$wrapper.append($("#error_rar__"));
                    //$wrapper.append($("#info_rar__"));
                ...
                if (args[0]) {
                    ...
                    if (args[0] == '*') {
                        ...
                        $('#' + settings.queueID).find('.uploadify-queue-item').each(function () {
                            ...
                            $(this).delay(0 + 100 * delay).fadeOut(0, function () {
                                $(this).remove();
                            });
                        });
                        ...
                        for (var n = 0; n < args.length; n++) {
                            ...
                            $('#' + args[n]).delay(0 + 100 * n).fadeOut(0, function () {
                                $(this).remove();
                            });
                        }
                    }
                    ...
                    $item.delay(0).fadeOut(0, function () {
                        $(this).remove();
                    });
                }
            });
